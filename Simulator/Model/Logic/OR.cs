...
namespace Simulator.Model.Logic
{
    ...
    {
        public static void AddInputAt(this Model.Logic.OR or, Element element)
        {
            var or3 = new Model.Logic.OR3();
            Project.UpdateElementAndFunction(or, element, or3);
        }

        public static void AddInputAt(this Model.Logic.OR3 or3, Element element)
        {
            var or4 = new Model.Logic.OR4();
            Project.UpdateElementAndFunction(or3, element, or4);
        }

        public static void RemoveInputAt(this Model.Logic.OR3 or3, Element element)
        {
            var or2 = new Model.Logic.OR();
            Project.UpdateElementAndFunction(or3, element, or2);
        }

        public static void AddInputAt(this Model.Logic.OR4 or4, Element element)
        {
            var or5 = new Model.Logic.OR5();
            Project.UpdateElementAndFunction(or4, element, or5);
        }

        public static void RemoveInputAt(this Model.Logic.OR4 or4, Element element)
        {
            var or3 = new Model.Logic.OR3();
            Project.UpdateElementAndFunction(or4, element, or3);
        }

        public static void AddInputAt(this Model.Logic.OR5 or5, Element element)
        {
            var or6 = new Model.Logic.OR6();
            Project.UpdateElementAndFunction(or5, element, or6);
        }

        public static void RemoveInputAt(this Model.Logic.OR5 or5, Element element)
        {
            var or4 = new Model.Logic.OR4();
            Project.UpdateElementAndFunction(or5, element, or4);
        }

        public static void AddInputAt(this Model.Logic.OR6 or6, Element element)
        {
            var or7 = new Model.Logic.OR7();
            Project.UpdateElementAndFunction(or6, element, or7);
        }

        public static void RemoveInputAt(this Model.Logic.OR6 or6, Element element)
        {
            var or5 = new Model.Logic.OR5();
            Project.UpdateElementAndFunction(or6, element, or5);
        }

        public static void AddInputAt(this Model.Logic.OR7 or7, Element element)
        {
            var or8 = new Model.Logic.OR8();
            Project.UpdateElementAndFunction(or7, element, or8);
        }

        public static void RemoveInputAt(this Model.Logic.OR7 or7, Element element)
        {
            var or6 = new Model.Logic.OR6();
            Project.UpdateElementAndFunction(or7, element, or6);
        }

        public static void RemoveInputAt(this Model.Logic.OR8 or8, Element element)
        {
            var or7 = new Model.Logic.OR7();
