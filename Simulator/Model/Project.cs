...
namespace Simulator.Model
{
    public static class Project
    {
        ...
        public static TreeNode[] GetLibraryTree()
        {
            ...
            mathNode.Nodes.Add(new TreeNode("Максимальное из двух") { Tag = typeof(Mathematic.MAX) });
            mathNode.Nodes.Add(new TreeNode("Среднее из двух") { Tag = typeof(Mathematic.AVG) });
            var arifNode = new TreeNode("Арифметика");
            mathNode.Nodes.Add(arifNode);
            arifNode.Nodes.Add(new TreeNode("Сложение") { Tag = typeof(Mathematic.ADD) });
            arifNode.Nodes.Add(new TreeNode("Вычитание") { Tag = typeof(Mathematic.SUB) });
            arifNode.Nodes.Add(new TreeNode("Умножение") { Tag = typeof(Mathematic.MUL) });
            arifNode.Nodes.Add(new TreeNode("Деление") { Tag = typeof(Mathematic.DIV) });
            arifNode.Nodes.Add(new TreeNode("Остаток от деления") { Tag = typeof(Mathematic.MOD) });
            mathNode.Nodes.Add(new TreeNode("Округление к верхнему") { Tag = typeof(Mathematic.ROND) });
            mathNode.Nodes.Add(new TreeNode("Округление в нижнему") { Tag = typeof(Mathematic.TRNC) });
            var powNode = new TreeNode("Степенные");
            mathNode.Nodes.Add(powNode);
            powNode.Nodes.Add(new TreeNode("Извлечение квадратного корня") { Tag = typeof(Mathematic.SQRT) });
            powNode.Nodes.Add(new TreeNode("Извлечение кубического корня") { Tag = typeof(Mathematic.CBRT) });
            powNode.Nodes.Add(new TreeNode("Степень числа") { Tag = typeof(Mathematic.POW) });
            powNode.Nodes.Add(new TreeNode("Экспонента числа") { Tag = typeof(Mathematic.EXP) });
            var logNode = new TreeNode("Логарифмы");
            mathNode.Nodes.Add(logNode);
            logNode.Nodes.Add(new TreeNode("Натуральный") { Tag = typeof(Mathematic.LN) });
            logNode.Nodes.Add(new TreeNode("Десятичный") { Tag = typeof(Mathematic.LOG) });
